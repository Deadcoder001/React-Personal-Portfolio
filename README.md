...
![Logo](https://github.com/Deadcoder001/AshifPf/blob/main/%20-3.jpg)
...
* `npm run dev`
    uns the app in development mode. Open [http://localhost:5173](http://localhost:5173) (or the port specified in your console) to view it in the browser.
